...
<span class="price"> &#8360 <?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
...
<?php 
$tid=1;
$sql = "SELECT tbltestimonial.Testimonial,tblusers.FullName,Vimage1 from tbltestimonial join tblusers on tbltestimonial.UserEmail=tblusers.EmailId where tbltestimonial.status=:tid limit 4";
$query = $dbh -> prepare($sql);
...
{  ?>
        ...
        <div class="testimonial-m">
         <img src="uploads/<?php echo htmlentities($result->Vimage1);?>" class="testimonial-img" width="280" height="200" alt="" /> 
