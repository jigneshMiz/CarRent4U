...
$sql="INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,pickuptiming,message,Status) VALUES(:BookingNumber,:useremail,:vhid,:fromdate,:todate,:fromtime,:message,:status)";
